...
public class PageNavigation {
	...
	public NavigatorInfoDto getNavigatorInfo() {
		...
		return NavigatorInfoDto.builder()
				...
				.endRange(endRange)
				.nextPage((this.endRange ? currentPage : (currentPage + 1)))
				.prevPage((this.startRange ? 1 : (currentPage - 1)))
				.build();
